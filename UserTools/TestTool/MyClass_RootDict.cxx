//
// File generated by rootcint at Wed Aug 24 17:51:33 2022
...
namespace ROOT {
   ...
   static void MyClass_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetClass();
   }
...
namespace ROOT {
   void MyClass_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      typedef ::ROOT::Shadow::MyClass ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetClass();
...
/* MyClass */
static int G__MyClass_RootDict_160_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   MyClass* p = NULL;
...
static int G__MyClass_RootDict_160_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   MyClass* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__MyClass_RootDict_160_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((MyClass*) G__getstructoffset())->Print());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__MyClass_RootDict_160_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((MyClass*) G__getstructoffset())->Set(*((string*) G__int(libp->para[0])), *((string*) G__int(libp->para[1]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__MyClass_RootDict_160_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((MyClass*) G__getstructoffset())->Get(*((string*) G__int(libp->para[0])), *(string*) libp->para[1].ref));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__MyClass_RootDict_160_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((MyClass*) G__getstructoffset())->Set(*((string*) G__int(libp->para[0])), (int) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__MyClass_RootDict_160_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__MyClass_RootDict_160_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static void G__setup_memfuncMyClass(void) {
   ...
   G__memfunc_setup("MyClass",700,G__MyClass_RootDict_160_0_1, 105, G__get_linked_tagnum(&G__MyClass_RootDictLN_MyClass), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MyClass",700,G__MyClass_RootDict_160_0_2, 105, G__get_linked_tagnum(&G__MyClass_RootDictLN_MyClass), -1, 0, 1, 1, 1, 0, "u 'MyClass' - 11 - other", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__MyClass_RootDict_160_0_3, 103, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Set",300,G__MyClass_RootDict_160_0_4, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - name u 'string' - 0 - in", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Get",288,G__MyClass_RootDict_160_0_5, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - name u 'string' - 1 - out", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Set",300,G__MyClass_RootDict_160_0_6, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - name i - - 0 - in", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Get",288,G__MyClass_RootDict_160_0_7, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - name i - - 1 - out", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~MyClass", 826, G__MyClass_RootDict_160_0_8, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
